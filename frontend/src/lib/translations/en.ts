export const en = {
  ...
  modLibraryEmptyTitle: 'No mods tracked yet',
  modLibraryEmptyDesc: 'Track manually managed mods, check for updates, and stage new versions before applying them.',
  modLibraryWarningCombine: 'This tracks mods placed directly in mods/, separate from the automatic Modrinth/CurseForge download list in the Mods tab. Avoid tracking the same jars in both places: REMOVE_OLD_MODS-style auto-management could delete files this panel installed.',
  modLibraryBrowseMods: 'Browse mods',
  modLibraryPasteLink: 'Paste a mod page link',
  modLibraryAddToLibrary: 'Add to library',
  modLibraryAlreadyTracked: 'Already tracked',
  modLibraryCheckAll: 'Check all for updates',
  modLibraryCheckOne: 'Check for updates',
  ...
  modLibraryRemoveFromDisk: 'Also delete the jar file(s) from disk',
  modLibrarySaveNotes: 'Save',
  modLibraryStatusUpToDate: 'Up to date',
  modLibraryStatusUpdateAvailable: 'Update available',
  modLibraryStatusStaged: 'Staged, not applied',
  modLibraryStatusMissing: 'Missing on disk',
  modLibraryDesiredVersion: 'Desired Minecraft version',
  modLibraryDesiredVersionHelp: 'Check mod readiness against an upcoming Minecraft version, e.g. before a quarterly release.',
  modLibraryCurrentVersion: 'Current version',
  modLibraryUpdatedUpstream: 'Updated upstream',
  modLibraryAddedOn: 'Added on',
  modLibraryDependencies: 'Dependencies',
  modLibraryDependencyRequired: 'required',
  modLibraryDependencyOptional: 'optional',
  modLibraryDependencyIncompatible: 'incompatible',
  modLibraryNotes: 'Notes',
  modLibraryNotesPlaceholder: 'e.g. This is optional and should not block an update',
  modLibraryBlockUpdate: "Don't flag this mod as blocking the update",
  modLibraryChangelog: 'Changelog',
  modLibraryLatestForCurrent: 'Latest for current version',
  modLibraryLatestForDesired: 'Latest for desired version',
  modLibraryErrorSearch: 'Could not complete the mod library action',
  modLibraryErrorResolveUrl: 'Could not resolve that mod URL',
  modLibraryErrorStage: 'Could not stage the mod download',
  modLibraryErrorApply: 'Could not apply the staged mod',
  modLibraryErrorCheck: 'Could not check for updates',
