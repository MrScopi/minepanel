...
export const es: Record<TranslationKey, string> = {
  ...
  modWatchDesc: 'Notas, un vigilante de la versión deseada e historial de registros de cambios para los mods fijados. Sigue disponible aunque el servidor esté en ejecución.',
  modWatchEmpty: 'Aún no hay mods fijados',
  modWatchEmptyHint: 'Usa "Buscar mods" arriba para agregar uno, o configura los mods en la pestaña Mods.',
  desiredMcVersion: 'Versión de Minecraft deseada',
  desiredMcVersionDesc: 'Comprueba la compatibilidad de los mods con una versión a la que estés pensando actualizar, sin cambiar la versión activa del servidor.',
  ...
  modWatchPendingBanner: '{count} cambio(s) pendiente(s) — se aplicarán automáticamente la próxima vez que este servidor inicie',
  modWatchQueuedAdd: 'En cola — se agregará en el próximo reinicio',
  modWatchQueuedRemove: 'En cola para eliminarse',
  modWatchUndo: 'Deshacer',
