...
export const es: Record<TranslationKey, string> = {
  ...
  modLibraryEmptyTitle: 'Aún no hay mods rastreados',
  modLibraryEmptyDesc: 'Rastrea mods gestionados manualmente, revisa actualizaciones y prepara nuevas versiones antes de aplicarlas.',
  modLibraryWarningCombine: 'Esto rastrea mods colocados directamente en mods/, independiente de la lista de descarga automática de Modrinth/CurseForge de la pestaña Mods. Evita rastrear los mismos archivos en ambos lugares: la gestión automática tipo REMOVE_OLD_MODS podría eliminar archivos instalados por este panel.',
  modLibraryBrowseMods: 'Buscar mods',
  modLibraryPasteLink: 'Pegar enlace de la página del mod',
  modLibraryAddToLibrary: 'Añadir a la biblioteca',
  modLibraryAlreadyTracked: 'Ya rastreado',
  modLibraryCheckAll: 'Buscar actualizaciones (todos)',
  modLibraryCheckOne: 'Buscar actualizaciones',
  ...
  modLibraryRemoveFromDisk: 'Eliminar también los archivos jar del disco',
  modLibrarySaveNotes: 'Guardar',
  modLibraryStatusUpToDate: 'Actualizado',
  modLibraryStatusUpdateAvailable: 'Actualización disponible',
  modLibraryStatusStaged: 'Preparado, sin aplicar',
  modLibraryStatusMissing: 'Falta en disco',
  modLibraryDesiredVersion: 'Versión de Minecraft deseada',
  modLibraryDesiredVersionHelp: 'Verifica si el mod está listo para una próxima versión de Minecraft, por ejemplo antes de un lanzamiento trimestral.',
  modLibraryCurrentVersion: 'Versión actual',
  modLibraryUpdatedUpstream: 'Actualizado en origen',
  modLibraryAddedOn: 'Añadido el',
  modLibraryDependencies: 'Dependencias',
  modLibraryDependencyRequired: 'requerida',
  modLibraryDependencyOptional: 'opcional',
  modLibraryDependencyIncompatible: 'incompatible',
  modLibraryNotes: 'Notas',
  modLibraryNotesPlaceholder: 'ej. Es opcional y no debería bloquear una actualización',
  modLibraryBlockUpdate: 'No marcar este mod como bloqueante de la actualización',
  modLibraryChangelog: 'Registro de cambios',
  modLibraryLatestForCurrent: 'Última versión para la versión actual',
  modLibraryLatestForDesired: 'Última versión para la versión deseada',
  modLibraryErrorSearch: 'No se pudo completar la acción de la biblioteca de mods',
  modLibraryErrorResolveUrl: 'No se pudo resolver esa URL de mod',
  modLibraryErrorStage: 'No se pudo preparar la descarga del mod',
  modLibraryErrorApply: 'No se pudo aplicar el mod preparado',
  modLibraryErrorCheck: 'No se pudo buscar actualizaciones',
