...
export const de: Record<TranslationKey, string> = {
  ...
  modWatchDesc: 'Notizen, eine Überwachung der gewünschten Version und der Verlauf des Änderungsprotokolls für angepinnte Mods. Bleibt auch verfügbar, während der Server läuft.',
  modWatchEmpty: 'Noch keine angepinnten Mods',
  modWatchEmptyHint: 'Verwenden Sie oben "Mods suchen", um einen hinzuzufügen, oder konfigurieren Sie Mods im Tab "Mods".',
  desiredMcVersion: 'Gewünschte Minecraft-Version',
  desiredMcVersionDesc: 'Prüfen Sie die Mod-Kompatibilität mit einer Version, auf die Sie ein Upgrade in Erwägung ziehen, ohne die aktive Version des Servers zu ändern.',
  ...
  modWatchPendingBanner: '{count} ausstehende Änderung(en) — wird beim nächsten Start dieses Servers automatisch angewendet',
  modWatchQueuedAdd: 'In Warteschlange — wird beim nächsten Neustart hinzugefügt',
  modWatchQueuedRemove: 'Zur Entfernung vorgemerkt',
  modWatchUndo: 'Rückgängig',
