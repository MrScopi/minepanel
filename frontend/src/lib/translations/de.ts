...
export const de: Record<TranslationKey, string> = {
  ...
  modLibrary: 'Mod-Bibliothek',
  modLibraryEmptyTitle: 'Noch keine Mods verfolgt',
  modLibraryEmptyDesc: 'Verfolge manuell verwaltete Mods, prüfe auf Updates und bereite neue Versionen vor, bevor du sie anwendest.',
  modLibraryWarningCombine: 'Dies verfolgt Mods, die direkt in mods/ abgelegt werden, getrennt von der automatischen Modrinth/CurseForge-Downloadliste im Tab Mods. Vermeide es, dieselben Dateien an beiden Stellen zu verfolgen: eine REMOVE_OLD_MODS-artige automatische Verwaltung könnte von diesem Panel installierte Dateien löschen.',
  modLibraryBrowseMods: 'Mods durchsuchen',
  modLibraryPasteLink: 'Mod-Seiten-Link einfügen',
  modLibraryAddToLibrary: 'Zur Bibliothek hinzufügen',
  modLibraryAlreadyTracked: 'Bereits verfolgt',
  modLibraryCheckAll: 'Alle auf Updates prüfen',
  modLibraryCheckOne: 'Auf Updates prüfen',
  ...
  modLibraryRemoveFromDisk: 'Auch die JAR-Datei(en) von der Festplatte löschen',
  modLibrarySaveNotes: 'Speichern',
  modLibraryStatusUpToDate: 'Aktuell',
  modLibraryStatusUpdateAvailable: 'Update verfügbar',
  modLibraryStatusStaged: 'Vorbereitet, nicht angewendet',
  modLibraryStatusMissing: 'Fehlt auf der Festplatte',
  modLibraryDesiredVersion: 'Gewünschte Minecraft-Version',
  modLibraryDesiredVersionHelp: 'Prüfe die Bereitschaft des Mods für eine kommende Minecraft-Version, z. B. vor einem vierteljährlichen Release.',
  modLibraryCurrentVersion: 'Aktuelle Version',
  modLibraryUpdatedUpstream: 'Beim Anbieter aktualisiert',
  modLibraryAddedOn: 'Hinzugefügt am',
  modLibraryDependencies: 'Abhängigkeiten',
  modLibraryDependencyRequired: 'erforderlich',
  modLibraryDependencyOptional: 'optional',
  modLibraryDependencyIncompatible: 'inkompatibel',
  modLibraryNotes: 'Notizen',
  modLibraryNotesPlaceholder: 'z. B. Dies ist optional und sollte ein Update nicht blockieren',
  modLibraryBlockUpdate: 'Diesen Mod nicht als Update-Blocker markieren',
  modLibraryChangelog: 'Änderungsprotokoll',
  modLibraryLatestForCurrent: 'Neueste Version für aktuelle Version',
  modLibraryLatestForDesired: 'Neueste Version für gewünschte Version',
  modLibraryErrorSearch: 'Aktion der Mod-Bibliothek konnte nicht abgeschlossen werden',
  modLibraryErrorResolveUrl: 'Diese Mod-URL konnte nicht aufgelöst werden',
  modLibraryErrorStage: 'Mod-Download konnte nicht vorbereitet werden',
  modLibraryErrorApply: 'Vorbereiteter Mod konnte nicht angewendet werden',
  modLibraryErrorCheck: 'Auf Updates konnte nicht geprüft werden',
