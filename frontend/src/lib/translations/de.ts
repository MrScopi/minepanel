...
export const de: Record<TranslationKey, string> = {
  ...
  modWatchDesc: 'Notes, a desired-version watcher, and changelog history for pinned mods. Stays available even while the server is running.',
  modWatchEmpty: 'No pinned mods yet',
  modWatchEmptyHint: 'Use "Search mods" above to add one, or configure mods in the Mods tab.',
  desiredMcVersion: 'Desired Minecraft Version',
  desiredMcVersionDesc: "Check mod compatibility against a version you're considering upgrading to, without changing the server's live version.",
  ...
  modWatchPendingBanner: '{count} pending change(s) — applied automatically the next time this server starts',
  modWatchQueuedAdd: 'Queued — added on next restart',
  modWatchQueuedRemove: 'Queued for removal',
  modWatchUndo: 'Undo',
