...
export const nl: Record<TranslationKey, string> = {
  ...
  modLibrary: 'Modbibliotheek',
  modLibraryEmptyTitle: 'Nog geen mods gevolgd',
  modLibraryEmptyDesc: 'Volg handmatig beheerde mods, controleer op updates en bereid nieuwe versies voor voordat je ze toepast.',
  modLibraryWarningCombine: 'Dit volgt mods die direct in mods/ zijn geplaatst, los van de automatische Modrinth/CurseForge-downloadlijst in het tabblad Mods. Vermijd dezelfde bestanden op beide plekken te volgen: REMOVE_OLD_MODS-achtig automatisch beheer kan bestanden verwijderen die dit paneel heeft geïnstalleerd.',
  modLibraryBrowseMods: 'Mods bladeren',
  modLibraryPasteLink: 'Modpagina-link plakken',
  modLibraryAddToLibrary: 'Toevoegen aan bibliotheek',
  modLibraryAlreadyTracked: 'Al gevolgd',
  modLibraryCheckAll: 'Alles op updates controleren',
  modLibraryCheckOne: 'Op updates controleren',
  ...
  modLibraryRemoveFromDisk: 'Ook de jar-bestand(en) van de schijf verwijderen',
  modLibrarySaveNotes: 'Opslaan',
  modLibraryStatusUpToDate: 'Up-to-date',
  modLibraryStatusUpdateAvailable: 'Update beschikbaar',
  modLibraryStatusStaged: 'Klaargezet, niet toegepast',
  modLibraryStatusMissing: 'Ontbreekt op schijf',
  modLibraryDesiredVersion: 'Gewenste Minecraft-versie',
  modLibraryDesiredVersionHelp: 'Controleer de gereedheid van de mod voor een aankomende Minecraft-versie, bijvoorbeeld vóór een kwartaalrelease.',
  modLibraryCurrentVersion: 'Huidige versie',
  modLibraryUpdatedUpstream: 'Bijgewerkt bij bron',
  modLibraryAddedOn: 'Toegevoegd op',
  modLibraryDependencies: 'Afhankelijkheden',
  modLibraryDependencyRequired: 'vereist',
  modLibraryDependencyOptional: 'optioneel',
  modLibraryDependencyIncompatible: 'incompatibel',
  modLibraryNotes: 'Notities',
  modLibraryNotesPlaceholder: 'bijv. Dit is optioneel en mag een update niet blokkeren',
  modLibraryBlockUpdate: 'Markeer deze mod niet als update-blokkerend',
  modLibraryChangelog: 'Wijzigingslog',
  modLibraryLatestForCurrent: 'Laatste versie voor huidige versie',
  modLibraryLatestForDesired: 'Laatste versie voor gewenste versie',
  modLibraryErrorSearch: 'Kon de modbibliotheekactie niet voltooien',
  modLibraryErrorResolveUrl: 'Kon die mod-URL niet herleiden',
  modLibraryErrorStage: 'Kon de moddownload niet klaarzetten',
  modLibraryErrorApply: 'Kon de klaargezette mod niet toepassen',
  modLibraryErrorCheck: 'Kon niet op updates controleren',
