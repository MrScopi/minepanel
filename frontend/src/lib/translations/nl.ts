...
export const nl: Record<TranslationKey, string> = {
  ...
  modWatchDesc: 'Notities, een bewaking van de gewenste versie en changelog-geschiedenis voor vastgezette mods. Blijft beschikbaar terwijl de server actief is.',
  modWatchEmpty: 'Nog geen vastgezette mods',
  modWatchEmptyHint: 'Gebruik hierboven "Mods zoeken" om er een toe te voegen, of configureer mods in het tabblad Mods.',
  desiredMcVersion: 'Gewenste Minecraft-versie',
  desiredMcVersionDesc: 'Controleer de mod-compatibiliteit met een versie waarnaar je overweegt te upgraden, zonder de live versie van de server te wijzigen.',
  ...
  modWatchPendingBanner: '{count} openstaande wijziging(en) — wordt automatisch toegepast bij de volgende start van deze server',
  modWatchQueuedAdd: 'In wachtrij — wordt toegevoegd bij de volgende herstart',
  modWatchQueuedRemove: 'In wachtrij voor verwijdering',
  modWatchUndo: 'Ongedaan maken',
