...
export const pl: Record<TranslationKey, string> = {
  ...
  modWatchDesc: 'Notatki, obserwator docelowej wersji oraz historia dzienników zmian dla przypiętych modów. Pozostaje dostępny nawet gdy serwer działa.',
  modWatchEmpty: 'Brak przypiętych modów',
  modWatchEmptyHint: 'Użyj powyżej "Szukaj modów", aby dodać jeden, albo skonfiguruj mody w zakładce Mody.',
  desiredMcVersion: 'Docelowa wersja Minecrafta',
  desiredMcVersionDesc: 'Sprawdź zgodność modów z wersją, na którą rozważasz aktualizację, bez zmiany aktywnej wersji serwera.',
  ...
  modWatchPendingBanner: '{count} oczekująca zmiana (zmiany) — zostaną zastosowane automatycznie przy następnym uruchomieniu tego serwera',
  modWatchQueuedAdd: 'W kolejce — zostanie dodany przy następnym restarcie',
  modWatchQueuedRemove: 'W kolejce do usunięcia',
  modWatchUndo: 'Cofnij',
