...
export const pl: Record<TranslationKey, string> = {
  ...
  modLibrary: 'Biblioteka modów',
  modLibraryEmptyTitle: 'Brak śledzonych modów',
  modLibraryEmptyDesc: 'Śledź ręcznie zarządzane mody, sprawdzaj aktualizacje i przygotowuj nowe wersje przed ich zastosowaniem.',
  modLibraryWarningCombine: 'To śledzi mody umieszczone bezpośrednio w mods/, niezależnie od listy automatycznego pobierania Modrinth/CurseForge w zakładce Mody. Unikaj śledzenia tych samych plików w obu miejscach: automatyczne zarządzanie w stylu REMOVE_OLD_MODS może usunąć pliki zainstalowane przez ten panel.',
  modLibraryBrowseMods: 'Przeglądaj mody',
  modLibraryPasteLink: 'Wklej link do strony moda',
  modLibraryAddToLibrary: 'Dodaj do biblioteki',
  modLibraryAlreadyTracked: 'Już śledzony',
  modLibraryCheckAll: 'Sprawdź wszystkie aktualizacje',
  modLibraryCheckOne: 'Sprawdź aktualizacje',
  ...
  modLibraryRemoveFromDisk: 'Usuń również pliki jar z dysku',
  modLibrarySaveNotes: 'Zapisz',
  modLibraryStatusUpToDate: 'Aktualny',
  modLibraryStatusUpdateAvailable: 'Dostępna aktualizacja',
  modLibraryStatusStaged: 'Przygotowany, niezastosowany',
  modLibraryStatusMissing: 'Brak na dysku',
  modLibraryDesiredVersion: 'Docelowa wersja Minecraft',
  modLibraryDesiredVersionHelp: 'Sprawdź gotowość moda na nadchodzącą wersję Minecraft, np. przed kwartalnym wydaniem.',
  modLibraryCurrentVersion: 'Aktualna wersja',
  modLibraryUpdatedUpstream: 'Zaktualizowano u źródła',
  modLibraryAddedOn: 'Dodano',
  modLibraryDependencies: 'Zależności',
  modLibraryDependencyRequired: 'wymagana',
  modLibraryDependencyOptional: 'opcjonalna',
  modLibraryDependencyIncompatible: 'niekompatybilna',
  modLibraryNotes: 'Notatki',
  modLibraryNotesPlaceholder: 'np. To jest opcjonalne i nie powinno blokować aktualizacji',
  modLibraryBlockUpdate: 'Nie oznaczaj tego moda jako blokującego aktualizację',
  modLibraryChangelog: 'Lista zmian',
  modLibraryLatestForCurrent: 'Najnowsza wersja dla aktualnej wersji',
  modLibraryLatestForDesired: 'Najnowsza wersja dla docelowej wersji',
  modLibraryErrorSearch: 'Nie udało się wykonać akcji biblioteki modów',
  modLibraryErrorResolveUrl: 'Nie udało się rozpoznać tego adresu URL moda',
  modLibraryErrorStage: 'Nie udało się przygotować pobierania moda',
  modLibraryErrorApply: 'Nie udało się zastosować przygotowanego moda',
  modLibraryErrorCheck: 'Nie udało się sprawdzić aktualizacji',
